...
<?php   }
    ...
    <input title="<?php _e('% Tax to apply', 'addonpayments' ); ?>" type="text" name="addonp_percent_tax_field" value="<?php echo get_option('addonp_percent_tax_field'); ?>" size="40" />
    <?php }
    ...
    <input title="<?php _e('% Retention to apply', 'addonpayments' ); ?>" type="text" name="addonp_percent_retention_field" value="<?php echo get_option('addonp_percent_retention_field'); ?>" size="40" />
    <?php }
