<?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
    ...
    <input title="<?php _e('Account', 'addonpayments' ); ?>" type="text" name="addonp_account_field" value="<?php echo get_option('addonp_account_field'); ?>"  size="40" />
    <?php }

    function addonp_shared_secret_field(){ ?>
    <input title="<?php _e('Shared Secret', 'addonpayments' ); ?>" type="text" name="addonp_shared_secret_field" value="<?php echo get_option('addonp_shared_secret_field'); ?>"  size="40" />
    <?php }
    ...
    add_settings_field( 'addonp_account_field', __('Account', 'addonpayments'), 'addonp_account_field', 'addonp-basic-settings-options', 'addonp-basic-settings-section' );
